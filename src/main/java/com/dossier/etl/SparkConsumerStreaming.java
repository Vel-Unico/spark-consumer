...
public class SparkConsumerStreaming {
   ...
   public static void main(String[] args) throws InterruptedException, IOException {
       ...
       kafkaParams.put("bootstrap.servers", "wn0-kafkad.r0dcnobojnzuxj5a1p23pnnv0a.bx.internal.cloudapp.net:9092,wn1-kafkad.r0dcnobojnzuxj5a1p23pnnv0a.bx.internal.cloudapp.net:9092");
